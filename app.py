...
def seed():
    ...
    if not Service.query.count():
        data=[('BPO Solutions','Voice, non-voice and customer operations built for scale.','🎧'),('Sales & Lead Generation','Qualified opportunities and structured customer outreach.','↗'),('Customer Support','Responsive customer care across channels.','◎'),('Corporate Training','Communication, sales and leadership capability building.','✦'),('Business Consulting','Process improvement, growth strategy and execution support.','◆'),('Workforce Management','Contract staffing and accountable workforce operations.','▦')]
    ...
    for slug,title,eye,body in [('about','About Nexicom Apex Global','Who we are','Nexicom Apex Global is a people-first business growth company serving BPO and business operations.\n\nOur mission is to connect capable people with meaningful opportunities and help businesses grow through disciplined execution.'),('contact','Contact Nexicom Apex Global','Let’s connect','Reach our team for outsourcing, consulting, partnerships or career enquiries.')]:
    ...
    if not Review.query.count():
        db.session.add(Review(client_name='Business Partner',company='Confidential Client',service_used='Support',rating=5,review_text='The Nexicom team brought structure, speed and accountability to our hiring process.',is_featured=True))
    db.session.commit()
